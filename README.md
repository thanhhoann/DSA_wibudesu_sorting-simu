...
<img src="src/components/assets/react_logo.jpg" alt="logo">
...
- []() Speed selection
  ...
  <img src="src/components/assets/speed_selection.png" alt="speed selection">

- []() Reset button

  <img src="src/components/assets/reset.png" alt="reset">

- []() Sort button

  <img src="src/components/assets/sort.png" alt="sort">

- []() Visualization area and sorting information

  <img src="src/components/assets/visualization_area.png" alt="area">
...
- []()For the scope: components (without styles package):
  ...
  <img src="src/components/assets/component_UML.png" alt="components_lUML">
